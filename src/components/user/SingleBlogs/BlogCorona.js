...
import img from '../../../images/Corona_awareness.jpg'
        ...
        <div className='s-b-col'> 
          ...
          <div className='s-b-col-1'>
            ...
            <div className='s-b-c-para'>
              <div className='s-b-c-p-h'>Keeping bike in Garage (not using) Due to CORONA Lock Down? Here are the tips from Garage on Call experts to Keep your Bike Healthy Start the bike once in two weeks and take it around for a short drive at-least 1-2 kms by changing gears, revving in higher RPMs etc. </div>
          ...
          <Link to="/tata-hexa-offering-benefits-upto-₹-2-2-lakh"><i class="fa-solid fa-arrow-left-long"></i> previous</Link>
